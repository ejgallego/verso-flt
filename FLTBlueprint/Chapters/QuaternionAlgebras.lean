...
in the adele miniproject (section {ref "adele_project"}[Adele miniproject]). Our automorphic forms will be certain
...
proved in the Fujisaki miniproject, chapter {ref "fujisaki_project"}[].
