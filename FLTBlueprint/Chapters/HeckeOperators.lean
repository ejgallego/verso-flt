...
quaternion algebra project {ref "Quat_alg_project"}[Miniproject: Quaternion algebras].
...
so lemma {bpref "bijOn_unipotent_mul_diagU1_U1diagU1"}[] applies. Let
...
```
:::theorem "nolean-hecke-algebra-commutative-noetherian" (parent := "hecke_operator_project")
