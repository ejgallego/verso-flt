...
After this chapter, you should next read {ref "ch_reductions"}[First reductions of the problem], which explains
...
{ref "ch_overview"}[An overview of the proof] is an extremely sketchy overview of how the rest of the
...
The next chapter to read, where the proof begins, is {ref "ch_reductions"}[First reductions of the problem].
